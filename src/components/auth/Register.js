                    ...
                    fetch("http://localhost:8000/register", {
                        ...
                        .then(createdUser => {
                            if (createdUser.hasOwnProperty("id")) {
                                localStorage.setItem("stock_customer", createdUser.id)
                                history.push("/")
                            }
                        })
                }
        ...
        <main className="register--main"style={{ textAlign: "center" }}>
            ...
            <form className="form--login" onSubmit={handleRegister}>
                ...
                <fieldset>
                    ...
                    <input onChange={updateManager} type="text" id="address" className="form-control" placeholder="Street address" required />
                </fieldset>
                <fieldset>
